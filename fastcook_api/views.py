...
def search_recipes(request):
    ...
    url = "https://api.edamam.com/search?q={}&app_id=9b103c7a&app_key=d23af99b892e026f695ff215031e3ac7".format(
        ingr)
    ...
    for i in response['hits']:
        ...
        recipe["totalTime"] = i['recipe']['totalTime']
        j = i['recipe']['ingredientLines']
        recipe["ingredients"] = []
        for ingredient in j:
            recipe["ingredients"].append(ingredient)

        #recipeImporter(recipe)
